...
class TransferTransactionController extends Controller
{
    ...
    public function index(){
        return view('report.agent-user.tranasctions.transfer-transaction.index');
    }
    ...
    public function generateReport(Request $request){
        ...
        return view('report.agent-user.tranasctions.transfer-transaction.cash-transaction', $data);
    }
