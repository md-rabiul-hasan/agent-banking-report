...
<main id="js-page-content" role="main" class="page-content">
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active">Transfer Transaction</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-edit'></i> Transfer Transaction Report
            <small>
                Transfer Transaction Report
            </small>
        </h1>
            ...
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <form id="user-create-form" method="POST" enctype="multipart/form-data" action="{{ route('report.transactions.transfer_transaction.generate.report') }}">   
                            @csrf                         
                            <div class="row">
                                <div class="col-md-3">
